...
# Clean old assets, keep .nojekyll and .gitignore
...
# Fix index.html: remove inline version script that overrides BUILD_VERSION
sed -i '/const params/d; /const version/d; /document.getElementById.*v:/d' index.html
